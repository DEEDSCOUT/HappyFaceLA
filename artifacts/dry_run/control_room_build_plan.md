...
**Spec fingerprint (SHA-256):** `0bd0c69d7f29faf06f4f25ee6941d3db0152acbdcddf45e674d6dc5ad845c6ac`  
...
### 25. `DERIVE_OPEN_BLOCKERS` — HF-LA Commercial Policy & Channel Governance Master
...
### 26. `DERIVE_ACTIVE_RULES_EXPORT` — HF-LA Commercial Policy & Channel Governance Master
...
### 27. `DERIVE_PUBLIC_PRICING_PACKAGES` — HF-LA Commercial Policy & Channel Governance Master
...
### 28. `DERIVE_AI_RESPONSE_MATRIX` — HF-LA Commercial Policy & Channel Governance Master

- **asset_type:** sheet
- **derivation:** FILTER where rule_category=AI_CUSTOMER_RESPONSE AND ai_response_review_status=APPROVED_FOR_AI
- **is_derived_view:** True
- **live_action:** False
- **source_tab:** 03_RULE_REGISTER_MASTER
